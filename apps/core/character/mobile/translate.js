...
const translates = {
	...
	re_heqi_prefix: "手杀",
	reqizhou: "绮胄",
	reqizhou_info: `锁定技，你根据装备区里牌的花色数获得以下技能：1种或以上：${get.poptip("yingzi")}；2种或以上：${get.poptip("jiang")}；3种或以上：${get.poptip("xinpojun")}；4种或以上：${get.poptip("dbchongjian")}；5种或以上：${get.poptip("fenwei")}。`,
	reshanxi: "闪袭",
